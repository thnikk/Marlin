...
#if defined(PB_PLAY)
  #define DAC_MOTOR_CURRENT_DEFAULT { 70, 70, 50, 50 } // Default drive percent - X, Y, Z, E axis
#elif defined(PB_SIMPLE)
  #define DAC_MOTOR_CURRENT_DEFAULT { 40, 40, 60, 60 } // Default drive percent - X, Y, Z, E axis
#else
